...
# Generate css/normalize.css from src/Css/Normalize.elm
elm-css Stylesheets.elm
# Clean and minify css/normalize.css
node_modules/.bin/cleancss -O1 specialComments:off --format keep-breaks  -o css/normalize.min.css normalize.css
...
# Clean and minify css/necolas.normalize.css
